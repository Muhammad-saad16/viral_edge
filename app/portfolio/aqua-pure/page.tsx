...
.results-bar { display: grid; grid-template-columns: repeat(4,1fr); border-top: 1px solid rgba(84,107,82,0.2); border-bottom: 1px solid rgba(84,107,82,0.2); background: rgba(84,107,82,0.06); }
...
.result-card:hover { background: rgba(84,107,82,0.06); transform: translateY(-2px); }
...
.cta-banner::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse at 50% 100%, rgba(84,107,82,0.07) 0%, transparent 60%); pointer-events: none; }
...
<nav>
  <div class="client-logo"><img src="/logos/UAE Logos/logo transparent.png" alt="Aqua Pure Water Technologies" /></div>
...
<div class="cta-banner">
  ...
  <div class="cta-buttons">
    ...
    <a href="https://wa.me/971551249617" class="btn-ghost" target="_blank">
