        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <a href={region === "UAE" ? "https://www.instagram.com/sqrd.ae?igsh=MXR2bzJ1OWUzbm51eg%3D%3D&utm_source=qr" : "https://www.instagram.com/sqrddigital"} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-9 h-9 border border-white/15 flex items-center justify-center text-white/45 hover:border-orange hover:text-orange hover:bg-orange/10 transition-all"
              ...
              <a href={region === "UAE" ? "https://www.facebook.com/share/1DuYeoanZp/?mibextid=wwXIfr" : "https://www.facebook.com/sqrddigital"} target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                className="w-9 h-9 border border-white/15 flex items-center justify-center text-white/45 hover:border-orange hover:text-orange hover:bg-orange/10 transition-all"
                style={{ borderRadius: "4px" }}>
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-white/45 hover:text-orange transition-colors font-medium">
                    {l.label}
                  </Link>
                </li>
              ))}
