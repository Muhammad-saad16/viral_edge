          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              <a href="https://www.instagram.com/sqrddigital" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-9 h-9 border border-white/15 flex items-center justify-center text-white/45 hover:border-sage hover:text-sage hover:bg-sage/10 transition-all"
